...
local easy_load_servers = {
    'bashls', 'jedi_language_server', 'html', 'gopls', 'svls', 'texlab', 'ocamllsp', 'elixirls', 'nimls', 'tsserver', 'html', 'hls', 'csharp_ls',
    'elixirls', 'clangd', 'zls', 'jdtls'
}
...
require'lspconfig'.lua_ls.setup {
    settings = {
        Lua = {
            misc = {parameters = {"--addon=ao"}},
            workspace = {userThirdParty = {"~/.luaddons/addons"}},
            diagnostics = {globals = {'vim', 'ao', 'Handlers'}}
        }
    }
}
