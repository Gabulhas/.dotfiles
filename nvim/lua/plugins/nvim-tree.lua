...
vim.keymap.set('n', '<C-n>', ':NvimTreeToggle<CR>',         {noremap = true, silent = true}) -- open/close
vim.keymap.set('n', '<leader>r', ':NvimTreeRefresh<CR>',    {noremap = true, silent = true}) -- refresh
vim.keymap.set('n', '<leader>n', ':NvimTreeFindFile<CR>',   {noremap = true, silent = true}) -- search file
